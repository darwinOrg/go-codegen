...
// EnterGolang_import_hint is called when production golang_import_hint is entered.
func (s *BaseServiceListener) EnterGolang_import_hint(ctx *Golang_import_hintContext) {}

// ExitGolang_import_hint is called when production golang_import_hint is exited.
func (s *BaseServiceListener) ExitGolang_import_hint(ctx *Golang_import_hintContext) {}

// EnterGolang_alias is called when production golang_alias is entered.
func (s *BaseServiceListener) EnterGolang_alias(ctx *Golang_aliasContext) {}

// ExitGolang_alias is called when production golang_alias is exited.
func (s *BaseServiceListener) ExitGolang_alias(ctx *Golang_aliasContext) {}
...
func (s *BaseServiceListener) EnterExtends(ctx *ExtendsContext) {}

// ExitExtends is called when production extends is exited.
func (s *BaseServiceListener) ExitExtends(ctx *ExtendsContext) {}

// EnterPoint is called when production point is entered.
func (s *BaseServiceListener) EnterPoint(ctx *PointContext) {}

// ExitPoint is called when production point is exited.
func (s *BaseServiceListener) ExitPoint(ctx *PointContext) {}
...
// EnterMethod_type_hint is called when production method_type_hint is entered.
func (s *BaseServiceListener) EnterMethod_type_hint(ctx *Method_type_hintContext) {}

// ExitMethod_type_hint is called when production method_type_hint is exited.
func (s *BaseServiceListener) ExitMethod_type_hint(ctx *Method_type_hintContext) {}
