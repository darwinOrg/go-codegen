...
type ServiceListener interface {
	...
	// EnterGolang_import_hint is called when entering the golang_import_hint production.
	EnterGolang_import_hint(c *Golang_import_hintContext)

	// EnterGolang_alias is called when entering the golang_alias production.
	EnterGolang_alias(c *Golang_aliasContext)
	...
	// EnterMethod_type_hint is called when entering the method_type_hint production.
	EnterMethod_type_hint(c *Method_type_hintContext)
	...
	// ExitGolang_import_hint is called when exiting the golang_import_hint production.
	ExitGolang_import_hint(c *Golang_import_hintContext)

	// ExitGolang_alias is called when exiting the golang_alias production.
	ExitGolang_alias(c *Golang_aliasContext)
	...
	// ExitMethod_type_hint is called when exiting the method_type_hint production.
	ExitMethod_type_hint(c *Method_type_hintContext)
